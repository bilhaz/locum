...
//        }
        ...
        public function get_product($id){
            ...
            $this->db->join('categories','categories.catId=products.catId'); 
            $this->db->join('authors','authors.autId=categories.autId'); 
            $query=$this->db->get('products');
            $result=$query->row_array();
            return $result;
        }
...
//            $this->db->limit(3,0);
        ...
        public function get_products_by_search($srch){
            $this->db->select('*'); 
            $this->db->like('LOWER(productTitle)',  urldecode($srch));  
//            $this->db->limit($limit,$offset);
...
//            return $result;
//        }
        public function get_orders_inc($limit,$offset){
            $this->db->select('*');  
...
//            print_r($result);exit;
        ...
        public function get_orders_inc_rows(){
            $this->db->select('*');  
//            $this->db->join('products','orders.productId=products.productId');
            $this->db->order_by('orderId','Desc');  
            $this->db->where('status <>',2);
