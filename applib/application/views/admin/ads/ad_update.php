...
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Update ad</h2>
<!--						<div class="box-icon">
					...
					<div class="box-content">
                                            <form id="test" action="<?=$ad_controller?>" method="post"  enctype="multipart/form-data">
						<div class="control-group">
								<label class="control-label" for="inputSuccess">ad Link</label>
								<div class="controls">
                                                                    <input type="text" name="title" value="<?=$ad['link']?>" required="">
								</div>
						</div>
                                                
                                                <div class="control-group">
								<label class="control-label" for="ad">ad Image</label>
								<div class="controls">
