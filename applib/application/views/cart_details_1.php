<main class="site-content" role="main" itemscope="itemscope" itemprop="mainContentOfPage" style="background-color: #FFF">
    <article id="post-1706" class="post-1706 page type-page status-publish hentry badges-style-3">
        <br><br><h2 class="page-title"><span>Shopping Cart</span></h2>
        <div class="entry-content">
            <div class="woocommerce" id="contents">
                <a class="button empty-cart" href="<?=  site_url('home/delete_cart')?>" onclick="return confirm('Are you sure you want to clear cart')">Delete All</a>
                          ...
                          <?php $total=0;  foreach($this->cart->contents() as $items)
                            ...
                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="#"><img width="300" height="300" src="<?php echo app_url."assets/products_thumbs/".$items['image'];?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail wp-post-image" alt=""></a>
                                </td>
                                <td class="product-name" data-title="Product"> <a href="#"><?=$items['name']?></a></td>
