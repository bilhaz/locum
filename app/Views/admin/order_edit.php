                        ...
                        <form action="<?= base_url('backend/order_edit/' . encryptIt($eord_row['ord_id'])) ?>"
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-4 ">
                                    ...
                                    <input type="text" id="ord_ref_no" name="ord_ref_no" class="form-control"
                                        placeholder="Locum Reference Number" value="<?= $eord_row['ord_ref_no'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="ord_cancel_bcl" name="ord_cancel_bcl" class="form-control select2">
                                        <option value="1" <?php if ($eord_row['ord_cancel_bcl'] == "1") { ?> echo
                                                selected="selected" <?php } ?>>Cancel</option>
                                        <option value="" <?php if ($eord_row['ord_cancel_bcl'] == "0") { ?> echo
                                                selected="selected" <?php } ?>>Active</option>
                            ...
                            <div class="row mb-3">
                                <?php if ($eord_row['ord_cancel_bdr'] == "1"): ?>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="<?= $eord_row['ord_dr_cremarks'] ?>"
                                            disabled>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($eord_row['ord_cancel_bcl'] == "1"): ?>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="<?= $eord_row['ord_cl_cremarks'] ?>"
                                            disabled>
                                    </div>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="ord_speciality" name="ord_speciality" class="form-control select2"
                                        ...
                                        <?php foreach ($sp_row as $srow): ?>
                                            <option value="<?= $srow['spec_id'] ?>" <?php if ($eord_row['ord_speciality'] == $srow['spec_id']) { ?> echo
                                                    selected="selected" <?php } ?>><?= $srow['spec_name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select id="ord_grade" name="ord_grade" class="form-control select2"
                                        ...
                                        <?php foreach ($gr_row as $grow): ?>
                                            <option value="<?= $grow['grade_id'] ?>" <?php if ($eord_row['ord_grade'] == $grow['grade_id']) { ?> echo selected="selected"
                                                <?php } ?>>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_required_from" name="ord_required_from" type="datetime-local"
                                        title="Click to enter date and time" class="form-control"
                                        value="<?= $eord_row['ord_required_from'] ?>">
                                </div>
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_required_to" name="ord_required_to" type="datetime-local"
                                        title="Click to enter date and time" class="form-control"
                                        value="<?= $eord_row['ord_required_to'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <textarea id="ord_datetime_detail" name="ord_datetime_detail" class="form-control"
                                    placeholder="Use comma separation for putting multiple dates and time for e.g: ' 23-02-2024 to 23-03-2024 08 to 21, 28-02-2023 18 to 22' "><?= $eord_row['ord_datetime_detail'] ?></textarea>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_process_details_from" name="ord_process_details_from"
                                        type="datetime-local" title="Click to enter date and time" class="form-control"
                            ...
                            <div class="row mb-3">
                                ...
                                <textarea id="ord_prosdatetime_detail" name="ord_prosdatetime_detail"
                                    class="form-control"
                                    placeholder="Use comma separation for putting multiple dates and time for e.g: ' 23-02-2024 to 23-03-2024 08 to 21, 28-02-2023 18 to 22' "><?= $eord_row['ord_prosdatetime_detail'] ?></textarea>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_process_date" name="ord_process_date" type="Date"
                                        ...
                                        value="<?= $eord_row['ord_process_date'] ?>">
                                </div>
                                <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="total" name="ord_total_hrs" oninput="payingdoc()" type="text"
                                        class="form-control" value="<?= $eord_row['ord_total_hrs'] ?>">
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="ord_hosp_earn" class="control-label mb-1">Total Earning from
                                        Hospital&nbsp;<small class="text-danger">(Office use only)</small></label>
                                    <input id="ord_hosp_earn" oninput="calculateTa();calculateDiff();"
                                        name="ord_hosp_earn" type="text" class="form-control"
                                        value="<?= $eord_row['ord_hosp_earn'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-3 ">
                                    ...
                                    <input id="ord_pay_to_dr" oninput="payingdoc()" name="ord_pay_to_dr" type="text"
                                        class="form-control" value="<?= $eord_row['ord_pay_to_dr'] ?>">
                                </div>
                                <div class="form-group col-md-3 ">
                                    <label for="ord_paying_to_dr" class="control-label mb-1">Paying to Dr.&nbsp;<small
                                            class="text-danger">(Office use only)</small></label>
                                    <input id="ord_paying_to_dr" name="ord_paying_to_dr" oninput="calculateDiff()"
                                        type="text" class="form-control" value="<?= $eord_row['ord_paying_to_dr'] ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="ord_admin_charges" oninput="calculateTa()" name="ord_admin_charges"
                                        type="text" class="form-control" value="<?= $eord_row['ord_admin_charges'] ?>">
                                </div>
                                ...
                                <div class="form-group col-md-3 ">
                                    ...
                                    <input id="Tadmin" name="ord_adminchrg_intern" oninput="calculateDiff()" type="text"
                                        class="form-control" value="<?= $eord_row['ord_adminchrg_intern'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="diff" class="control-label mb-1">Diff (Profit) + Admin
                                        Charges</label>
                                    <input id="diff" name="ord_diff_profit_admin" type="text" class="form-control"
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select id="ord_time_sheet_mode" name="ord_time_sheet_mode"
                                        ...
                                        <option value="fax" <?php if ($eord_row['ord_time_sheet_mode'] == "fax") { ?> echo
                                                selected="selected" <?php } ?>>fax</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select id="ord_time_sheet_approved" name="ord_time_sheet_approved" type="text"
                                        ...
                                        <option value="Due" <?php if ($eord_row['ord_time_sheet_approved'] == "Due") { ?>
                                                echo selected="selected" <?php } ?>>Due</option>
                                        <option value="Received" <?php if ($eord_row['ord_time_sheet_approved'] == "Received") { ?> echo
                                                selected="selected" <?php } ?>>Received</option>
                                        <option value="Sent_for_verification" <?php if ($eord_row['ord_time_sheet_approved'] == "Sent_for_verification") { ?> echo
                                                selected="selected" <?php } ?>>Sent For Verification</option>
                                        <option value="Approved" <?php if ($eord_row['ord_time_sheet_approved'] == "Approved") { ?> echo
                                                selected="selected" <?php } ?>>Approved</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_vat_sale" name="ord_vat_sale" oninput="calculatevat()" type="text"
                                        class="form-control" value="<?= $eord_row['ord_vat_sale'] ?>">
                                </div>
                                <div class="form-group col-md-6 ">
                                    <label for="ord_invoice_id" class="control-label mb-1">VAT on Purchase</label>
                                    <input id="ord_vat_purch" name="ord_vat_purch" oninput="calculatevat()" type="text"
                                        class="form-control" value="<?= $eord_row['ord_vat_purch'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="vat" class="control-label mb-1">VAT SAVED</label>
                                    <input id="vat" name="ord_vat_save" type="text" class="form-control"
                                        value="<?= $eord_row['ord_vat_save'] ?>">
                                </div>
                                <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="ord_invoice_date" name="ord_invoice_date" type="date"
                                        title="Click to enter date" class="form-control"
                                        value="<?= $eord_row['ord_invoice_date'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="ord_pay_to_dr_date" class="control-label mb-1">Paid to Employee
                                        Date</label>
                                    <input id="ord_pay_to_dr_date" name="ord_pay_to_dr_date" type="date"
                                        title="Click to enter date" class="form-control"
                                        value="<?= $eord_row['ord_pay_to_dr_date'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="ord_payment_status" class="control-label mb-1">Employee Payment
                                        Status</label>
