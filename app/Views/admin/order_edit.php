            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" id="ord_ref_no" name="ord_ref_no" class="form-control" placeholder="Locum Reference Number" value="<?= $eord_row['ord_ref_no']?>">
                                </div>
                                </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="ord_cancel_bdr" name="ord_cancel_bdr" class="form-control select2">
                                        ...
                                        <option value="" <?php if (empty($eord_row['ord_cancel_bdr'])) { ?> echo selected="selected" <?php } ?>>Active</option>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="ord_required_from" class="ord_required_from-label mb-1">Locum Required
                                        From</label>
                                    <input id="ord_required_from" name="ord_required_from" type="datetime-local" title="Click to enter date and time" class="form-control" value="<?= $eord_row['ord_required_from'] ?>">
                                </div>
                                <div class="form-group col-md-6 ">
                                    <label for="ord_required_to" class="control-label mb-1">Locum Required To</label>
                                    <input id="ord_required_to" name="ord_required_to" type="datetime-local" title="Click to enter date and time" class="form-control" value="<?= $eord_row['ord_required_to'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="ord_process_details_from" class="control-label mb-1">Locum Process
                                        From</label>
                                    <input id="ord_process_details_from" name="ord_process_details_from" type="datetime-local" title="Click to enter date and time" class="form-control" value="<?= $eord_row['ord_process_details_from'] ?>">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="ord_normal_hrs" name="ord_normal_hrs" oninput="calculate()" type="text"  class="form-control" value="<?= $eord_row['ord_normal_hrs'] ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ord_on_call_hrs" class="control-label mb-1">No of On Call Hours</label>
                                    <input id="ord_on_call_hrs" name="ord_on_call_hrs" oninput="calculate()" type="text" class="form-control" value="<?= $eord_row['ord_on_call_hrs'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="total" class="control-label mb-1">Total Hours</label>
                                    <input id="total" name="ord_total_hrs" oninput="payingdoc()" type="text" class="form-control" value="<?= $eord_row['ord_total_hrs'] ?>">
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="ord_hosp_earn" oninput="calculateTa();calculateDiff();" name="ord_hosp_earn" type="text" class="form-control" value="<?= $eord_row['ord_hosp_earn'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-3 ">
                                    <label for="ord_pay_to_dr" class="control-label mb-1">Pay to Dr.</label>
                                    <input id="ord_pay_to_dr" oninput="payingdoc()" name="ord_pay_to_dr" type="text" class="form-control" value="<?= $eord_row['ord_pay_to_dr'] ?>">
                                </div>
                                <div class="form-group col-md-3 ">
                                    <label for="ord_paying_to_dr" class="control-label mb-1">Paying to Dr.&nbsp;<small class="text-danger">(Office use only)</small></label>
                                    <input id="ord_paying_to_dr"  name="ord_paying_to_dr" oninput="calculateDiff()" type="text" class="form-control" value="<?= $eord_row['ord_paying_to_dr'] ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="ord_admin_charges" class="control-label mb-1">Admin Charges</label>
                                    <input id="ord_admin_charges" oninput="calculateTa()" name="ord_admin_charges" type="text" class="form-control" value="<?= $eord_row['ord_admin_charges'] ?>">
                                </div>
                                ...
                                <div class="form-group col-md-3 ">
                                    ...
                                    <input id="Tadmin" name="ord_adminchrg_intern" oninput="calculateDiff()" type="text" class="form-control" value="<?= $eord_row['ord_adminchrg_intern'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="diff" class="control-label mb-1">Diff (Profit) + Admin
                                        Charges</label>
                                    <input id="diff" name="ord_diff_profit_admin" type="text" class="form-control" value="<?= $eord_row['ord_diff_profit_admin'] ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ord_time_sheet_rcvd" class="control-label mb-1">Time Sheet
                                        received</label>
                                    <input id="ord_time_sheet_rcvd" name="ord_time_sheet_rcvd" type="Date" title="Click to enter date" class="form-control" value="<?= $eord_row['ord_time_sheet_rcvd'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select id="ord_time_sheet_approved" name="ord_time_sheet_approved" type="text" class="form-control select2" data-parsley-trigger="change">
                                        ...
                                        <option value="Due" <?php if ($eord_row['ord_time_sheet_approved'] == "Due") { ?> echo selected="selected" <?php } ?>>Due</option>
                                        <option value="Received" <?php if ($eord_row['ord_time_sheet_approved'] == "Received") { ?> echo selected="selected" <?php } ?>>Received</option>
                                        <option value="Sent_for_verification" <?php if ($eord_row['ord_time_sheet_approved'] == "Sent_for_verification") { ?> echo selected="selected" <?php } ?>>Sent For Verification</option>
                           ...
                           <div class="row mb-3">
                            ...
                            <input id="ord_vat_sale" name="ord_vat_sale" oninput="calculatevat()" type="text" class="form-control" value="<?= $eord_row['ord_vat_sale'] ?>">
                                    </div>
                                     <div class="form-group col-md-6 ">
                            <label for="ord_invoice_id" class="control-label mb-1">VAT on Purchase</label>
                            <input id="ord_vat_purch" name="ord_vat_purch" oninput="calculatevat()" type="text" class="form-control" value="<?= $eord_row['ord_vat_purch'] ?>">
                            </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="vat" class="control-label mb-1">VAT SAVED</label>
                            <input id="vat" name="ord_vat_save" type="text" class="form-control" value="<?= $eord_row['ord_vat_save'] ?>">
                                    </div>
                                     <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="ord_invoice_date" name="ord_invoice_date" type="date" title="Click to enter date" class="form-control" value="<?= $eord_row['ord_invoice_date'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="ord_invoice_by" class="control-label mb-1">Invoice By</label>
                                    <input id="ord_invoice_by" name="ord_invoice_by" type="text" class="form-control" value="<?= $eord_row['ord_invoice_by'] ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ord_sage_refer_no" class="control-label mb-1">Sage Reference No.</label>
                                    <input id="ord_sage_refer_no" name="ord_sage_refer_no" type="text" class="form-control" value="<?= $eord_row['ord_sage_refer_no'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                                    <label for="ord_paymnt_rcvd_date" class="control-label mb-1">Payment Received
                                        Date</label>
                                    <input id="ord_paymnt_rcvd_date" name="ord_paymnt_rcvd_date" type="date" title="Click to enter date" class="form-control" value="<?= $eord_row['ord_paymnt_rcvd_date'] ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ord_pay_to_dr_date" class="control-label mb-1">Paid to Employee Date</label>
                                    <input id="ord_pay_to_dr_date" name="ord_pay_to_dr_date" type="date" title="Click to enter date" class="form-control" value="<?= $eord_row['ord_pay_to_dr_date'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-6 ">
                            ...
                            <div class="row mb-3">
                                ...
                                <input class="form-control" type="file" name="ord_assignment" id="formFile" data-parsley-max-file-size="2000" />
                            ...
                            <?php if (!empty($eord_row['ord_assignment'])) : ?>
                                <div class="row mb-3">
                                    <p><a target="_blank" href="<?= base_url('public/uploads/doc_assesment/' . $eord_row['ord_assignment']) ?>">View
                                            Assesment</a></p>
                                </div>
                            <?php endif; ?>
                            <hr class="primary">
                            ...
                            <div style="float:right !important;">
                                ...
                                <a id="payment-button" href="<?= base_url('backend/orders') ?>" class="btn btn-lg btn-dark text-light btn-block">
