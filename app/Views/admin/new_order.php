            ...
            <div class="col-lg-12">
                ...
                <div id="wizard_horizontal" role="application" class="wizard clearfix">
                    <div class="steps clearfix">
                        <ul role="tablist">
                            <li role="tab" class="first current" aria-disabled="false" aria-selected="false"><a
                                    id="wizard_horizontal-t-0"
                                    aria-controls="wizard_horizontal-p-0"><span class="number">1.</span> First Response</a>
                            </li>
                            <li role="tab" class="second disabled" aria-disabled="false" aria-selected="true"><a
                            ...
                            <li role="tab" class="third disabled" aria-disabled="true"><a id="wizard_horizontal-t-2"
