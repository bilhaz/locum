...
<h2 class="m-0 fs-5"><a href="javascript:void(0);" class="btn btn-sm btn-link ps-0 btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Paid Payments</h2>
...
<h6 class="card-title">Paid Paymen list</h6>
...
<td><span class="badge bg-success"><?= $row['ord_payment_status']?></span></td>
<td>
