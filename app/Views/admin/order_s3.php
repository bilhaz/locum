                ...
                <div id="wizard_horizontal" role="application" class="wizard clearfix">
                    <div class="steps clearfix">
                        <ul role="tablist">
                            ...
                            <li role="tab" class="third current" aria-disabled="true"><a id="wizard_horizontal-t-2"
                                     aria-controls="wizard_horizontal-p-2"><span
                                        class="number">3.</span> Client Confirmation</a></li>
                            <li role="tab" class="last disabled" aria-disabled="false"><a id="wizard_horizontal-t-3"
                                     aria-controls="wizard_horizontal-p-3"><span
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <?php if ($v_ordr['ord_cancel_bcl'] == "1"): ?>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" value="<?= $v_ordr['ord_cl_cremarks'] ?>"
                                            disabled>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($v_ordr['ord_cancel_bdr'] == "1"): ?>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="<?= $v_ordr['ord_dr_cremarks'] ?>"
                                            disabled>
                                    </div>
                                <?php endif; ?>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-4 ">
                                    ...
                                    <input id="ord_normal_hrs" name="ord_normal_hrs" oninput="calculate()" type="text" disabled class="form-control" value="<?= $v_ordr['ord_normal_hrs'] ? $v_ordr['ord_normal_hrs'] : set_value('ord_normal_hrs') ?>">
                                </div>
                            <div class="form-group col-md-4 ">
                            <label for="ord_normal_hrs_rt" class="control-label mb-1">Rate for Normal Hrs</label>
                                    <input id="ord_normal_hrs_rt" name="ord_normal_hrs_rt"  type="text"  class="form-control" disabled value="<?= $v_ordr['ord_normal_hrs_rt'] ? $v_ordr['ord_normal_hrs_rt'] : set_value('ord_normal_hrs_rt') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            ...
                            <div class="form-group col-md-4 ">
                                    ...
                                    <input id="ord_on_call_hrs" name="ord_on_call_hrs" oninput="calculate()" disabled type="text" class="form-control" value="<?= $v_ordr['ord_on_call_hrs'] ? $v_ordr['ord_on_call_hrs'] : set_value('ord_on_call_hrs') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            <label for="ord_ocall_rt" class="control-label mb-1">Rate for OnCall Hrs</label>
                                    <input id="ord_ocall_rt" name="ord_ocall_rt"  type="text"  class="form-control" disabled value="<?= $v_ordr['ord_ocall_rt'] ? $v_ordr['ord_ocall_rt'] : set_value('ord_ocall_rt') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            ...
                            <div class="form-group col-md-4 ">
                                    ...
                                    <input id="ord_off_site_hrs" name="ord_off_site_hrs" oninput="calculate()" disabled type="text" class="form-control" value="<?= $v_ordr['ord_off_site_hrs'] ? $v_ordr['ord_off_site_hrs'] : set_value('ord_off_site_hrs') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            <label for="ord_osite_rt" class="control-label mb-1">Rate for OffSite Hrs</label>
                                    <input id="ord_osite_rt" name="ord_osite_rt"  type="text"  class="form-control" disabled value="<?= $v_ordr['ord_osite_rt'] ? $v_ordr['ord_osite_rt'] : set_value('ord_osite_rt') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            ...
                            <div class="form-group col-md-4 ">
                                    ...
                                    <input id="ord_bh_week_hrs" name="ord_bh_week_hrs" oninput="calculate()" disabled type="text" class="form-control" value="<?= $v_ordr['ord_bh_week_hrs'] ? $v_ordr['ord_bh_week_hrs'] : set_value('ord_bh_week_hrs') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                            <label for="ord_bhw_rt" class="control-label mb-1">Rate for BH/Weekend Hrs</label>
                                    <input id="ord_bhw_rt" name="ord_bhw_rt"  type="text"  class="form-control" disabled value="<?= $v_ordr['ord_bhw_rt'] ? $v_ordr['ord_bhw_rt'] : set_value('ord_bhw_rt') ?>">
                                        </div>
                                        <div class="form-group col-md-4 ">
                                ...
                                <div class="form-group col-md-4 ">
                                <label for="ord_hosp_earn" class="control-label mb-1">Total Earning from Client&nbsp;<small class="text-danger">(Office use only)</small></label>
                                    <input id="ord_hosp_earn" oninput="calculateTa();calculateDiff();" required="" name="ord_hosp_earn" type="text" class="form-control" value="<?= $v_ordr['ord_hosp_earn'] ? $v_ordr['ord_hosp_earn'] : set_value('ord_hosp_earn') ?>">
                                </div>
                                        </div>
                                        <div class="row mb-3">
                                <div class="form-group col-md-4 ">
                            ...
                            <input id="vat_rate" name="vat_rate" type="text" class="form-control" required="" value="<?= $v_ordr['vat_rate'] ? $v_ordr['vat_rate'] : set_value('vat_rate') ?>">
                                    </div>
                                    <div class="form-group col-md-4 ">
