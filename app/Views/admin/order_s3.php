                ...
                <div id="wizard_horizontal" role="application" class="wizard clearfix">
                    <div class="steps clearfix">
                        <ul role="tablist">
                            ...
                            <li role="tab" class="last disabled" aria-disabled="false"><a id="wizard_horizontal-t-3" aria-controls="wizard_horizontal-p-3"><span class="number">5.</span> Payments</a></li>                        </ul>
                    </div>
                            ...
                            <form action="<?= base_url('backend/order-s3/' . encryptIt($v_ordr['ord_id'])) ?>" method="post" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8" data-parsley-validate="" id="forma">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="emp_id" name="emp_id" class="form-control select2" data-parsley-trigger="change" required onchange="checkCancellation()">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-md-3 ">
                                        <label for="ord_Hnormal_hrs_rt" class="control-label mb-1">Rate for Hosp Normal
                                            Hrs</label>
                                        <input id="ord_Hnormal_hrs_rt" name="ord_Hnormal_hrs_rt" oninput="calculateEc()" type="text" class="form-control" value="<?= $v_ordr['ord_Hnormal_hrs_rt'] ? $v_ordr['ord_Hnormal_hrs_rt'] : set_value('ord_Hnormal_hrs_rt', '0') ?>" required="">
                                    </div>
                                    <div class="form-group col-md-3 ">
                                ...
                                <div class="row mb-3">
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <input id="total" name="ord_total_hrs" oninput="payingdoc()" type="text" readonly class="form-control" value="<?= $v_ordr['ord_total_hrs'] ? $v_ordr['ord_total_hrs'] : set_value('ord_total_hrs') ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="ord_admin_charges" class="control-label mb-1">Admin Charges</label>
                                        <input id="ord_admin_charges" oninput="calculateTa()" name="ord_admin_charges" type="text" class="form-control" value="<?= $v_ordr['ord_admin_charges'] ? $v_ordr['ord_admin_charges'] : set_value('ord_admin_charges') ?>" required>
                                    </div>
                                    <div class="form-group col-md-4 ">
                                        <label for="TcliEarn" class="control-label mb-1">Total Earning from Client&nbsp;<small class="text-danger">(Office use only)</small></label>
                                        <input id="TcliEarn" oninput="calculateTa();calculateDiff();calculateVosale()" required="" name="ord_hosp_earn" type="text" class="form-control" value="<?= $v_ordr['ord_hosp_earn'] ? $v_ordr['ord_hosp_earn'] : set_value('ord_hosp_earn') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="form-group col-md-4 ">
                                    ...
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <select id="vat_rate" name="vat_rate" class="form-control select2" onchange="calculateVosale()" required="" data-parsley-trigger="change">
                                    ...
                                    <div class="form-group col-md-4 ">
                                        <label for="Vatos" class="control-label mb-1">VAT on Sale</label>
