        ...
        <div class="block-header py-lg-4 py-3">
            <div class="row g-3">
                <div class="col-md-6 col-sm-12 d-print-none">
                    <h2 class="m-0 fs-5"><a href="javascript:void(0);" class="btn btn-sm btn-link ps-0 btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>View Order</h2>
                                ...
                                <div class="tab-pane fade show active" id="details" role="tabpanel">
                                    <div class="row">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 text-end">
                                                ...
                                                <p class="mb-0"><strong>Payment Status: </strong>
                                                    <?php if ($ordr_row['ord_payment_status'] == 'Due') : ?>
                                                ...
                                                <p class="mb-0"><strong>Emp Payment Status: </strong>
                                                    <?php if ($ordr_row['ord_emp_pay_status'] == 'Due') : ?>
                                                        <span class="badge chart-color123">Due</span>
                                                    <?php elseif ($ordr_row['ord_emp_pay_status'] == 'Paid') : ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php if (!empty($ordr_row['ord_assignment'])) : ?>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <a target="_blank" id="tocopy" href="<?= base_url('public/uploads/doc_assesment/' . $ordr_row['ord_assignment']) ?>">View
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <span class="cview ">
                                                        <?= $ordr_row['ord_normal_hrs'] ?>/Hrs&nbsp;[<b>Emp</b> (&euro;<?= $ordr_row['ord_normal_hrs_rt'] ?> per&nbsp;<?php if ($ordr_row['nh_p_type'] == '1') : echo "hr";
                                                                                                                                                                        elseif ($ordr_row['nh_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                        else : echo "H-day";
                                                                                                                                                                        endif; ?>)&nbsp; <b>Client</b> (&euro;<?= $ordr_row['ord_Hnormal_hrs_rt'] ?> per&nbsp;<?php if ($ordr_row['nh_p_type'] == '1') : echo "hr";
                                                                                                                                                                                                                                                                                                                                                                                        elseif ($ordr_row['nh_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                                                                                                                                                                                                                                        else : echo "H-day";
                                                                                                                                                                                                                                                                                                                                                                                        endif; ?>)]
                                                    </span>
                                            ...
                                            <?php if ($ordr_row['ord_on_call_hrs'] > '0') : ?>
                                                <div class="row mb-3">
                                                    <div class="form-group col-md-6 ">
                                                        <h6 class="control-label ">OnCall Hours:</h6>
                                                        <hr class="primary">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <span class="cview ">
                                                            <?= $ordr_row['ord_on_call_hrs'] ?>/Hrs&nbsp; [<b>Emp</b> (&euro;<?= $ordr_row['ord_ocall_rt'] ?> per&nbsp;<?php if ($ordr_row['oc_p_type'] == '1') : echo "hr";
                                                                                                                                                                        elseif ($ordr_row['oc_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                        else : echo "H-day";
                                                                                                                                                                        endif; ?>)&nbsp; <b>Client</b> (&euro;<?= $ordr_row['ord_Hocall_rt'] ?> per&nbsp;<?php if ($ordr_row['oc_p_type'] == '1') : echo "hr";
                                                                                                                                                                                                                                                                                                                                                                                    elseif ($ordr_row['oc_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                                                                                                                                                                                                                                    else : echo "H-day";
                                                                                                                                                                                                                                                                                                                                                                                    endif; ?>)]
                                                        </span>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($ordr_row['ord_off_site_hrs'] > '0') : ?>
                                                <div class="row mb-3">
                                                    <div class="form-group col-md-6 ">
                                                        <h6 class="control-label ">OffSite Hours:</h6>
                                                        <hr class="primary">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <span class="cview ">
                                                            <?= $ordr_row['ord_off_site_hrs'] ?>/Hrs&nbsp; [<b>Emp</b> (&euro;<?= $ordr_row['ord_osite_rt'] ?> per&nbsp;<?php if ($ordr_row['os_p_type'] == '1') : echo "hr";
                                                                                                                                                                        elseif ($ordr_row['os_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                        else : echo "H-day";
                                                                                                                                                                        endif; ?>) <b>Client</b> (&euro;<?= $ordr_row['ord_osite_rt'] ?> per&nbsp;<?php if ($ordr_row['os_p_type'] == '1') : echo "hr";
                                                                                                                                                                                                                                                                                                                                                                            elseif ($ordr_row['os_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                                                                                                                                                                                                                            else : echo "H-day";
                                                                                                                                                                                                                                                                                                                                                                            endif; ?>)]
                                                        </span>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($ordr_row['ord_bh_week_hrs'] > '0') : ?>
                                                <div class="row mb-3">
                                                    <div class="form-group col-md-6 ">
                                                        <h6 class="control-label ">BH/Weekend Hours:</h6>
                                                        <hr class="primary">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <span class="cview ">
                                                            <?= $ordr_row['ord_bh_week_hrs'] ?>/Hrs&nbsp; [<b>Emp</b> (&euro;<?= $ordr_row['ord_bhw_rt'] ?> per&nbsp;<?php if ($ordr_row['bhw_p_type'] == '1') : echo "hr";
                                                                                                                                                                    elseif ($ordr_row['bhw_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                    else : echo "H-day";
                                                                                                                                                                    endif; ?>) <b>Client</b> (&euro;<?= $ordr_row['ord_Hbhw_rt'] ?> per&nbsp;<?php if ($ordr_row['bhw_p_type'] == '1') : echo "hr";
                                                                                                                                                                                                                                                                                                                                                                            elseif ($ordr_row['bhw_p_type'] == '2') : echo "F-Day";
                                                                                                                                                                                                                                                                                                                                                                            else : echo "H-day";
                                                                                                                                                                                                                                                                                                                                                                            endif; ?>)]
                                                        </span>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-group col-md-6 ">
                                                    <h6 class="control-label ">Total Paying to Dr :</h6>
                                                    <hr class="primary">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <span class="cview ">
                                                        &euro;<?= $ordr_row['ord_paying_to_dr'] ?>
                                                    </span>
                                                    <hr class="primary">
                                                </div>
                                            </div>
                                            ...
                                            <?php if (!empty($ordr_row['ord_comment1'])) : ?>
                                                <div class="row mb-3">
                                                    <div class="form-group col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-group col-md-6">
                                                    <h6 class="control-label ">Sage Invoice ID:</h6>
                                                    <hr class="primary">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <span class="cview">
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-group col-md-6">
                                                    <h6 class="control-label ">Paid to Employee on :</h6>
                                                    <hr class="primary">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <span class="cview">
                                            ...
                                            <?php if (!empty($ordr_row['ord_comment2'])) : ?>
                                                <div class="row mb-3">
                                                    <div class="form-group col-md-6">
                                                        <h6 class="control-label ">Payment Remarks :</h6>
                                                        <hr class="primary">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <span class="cview">
