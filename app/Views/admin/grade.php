...
<li>
<a type="button" href="<?=base_url('admin/new_grade')?>" class="btn btn-sm btn-outline-primary">Add New</a>
</li>
</ul>
</div>
...
<a type="button" href="<?= base_url('admin/edit_grade/'. encryptIt($row['grade_id']))?>" class="btn btn-sm btn-outline-success" title="Edit"><i class="fa fa-edit"></i></a>

<a type="button" href="<?= base_url('admin/del_grade/'.encryptIt($row['grade_id']))?>" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" Onclick="return confirm('Are You sure?');" data-type="confirm"><i class="fa fa-trash"></i></a>
</td>
</tr>
<?php endforeach; ?>
