                ...
                <div id="wizard_horizontal" role="application" class="wizard clearfix">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('backend/order-s2/' . encryptIt($v_ordr['ord_id'])) ?>" method="post" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8" data-parsley-validate="data-parsley-validate" id="forma">
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="emp_id" name="emp_id" class="form-control select2" required="" data-parsley-trigger="change">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <!-- Data Parsely error creating -->
                                    <div class="form-group col-md-4">
                                        <label for="ord_process_date" class="control-label mb-1">Processed Date</label>
                                        <input id="or_process_date" name="ord_process_date" type="date" title="Click to enter date"  class="form-control" required="" value="<?= $v_ordr['ord_process_date'] ? $v_ordr['ord_process_date'] : set_value('ord_process_date') ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
