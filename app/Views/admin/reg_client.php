...
<div class="card-body">
<form action="<?= base_url('admin/reg_client')?>" method="post" data-parsley-validate="" id="forma" autocomplete="off">
...
<a id="cancel" href="<?= base_url('admin/clients') ?>" class="btn btn-lg btn-dark btn-block">
