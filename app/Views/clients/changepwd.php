...
<div class="card-body">
                            ...
                            <hr>
                            <form action="<?= base_url('client/pwdupd') ?>" method="post" validate="validate">
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">New Password</label>
                                    <input id="cc-pament" name="cl_cont_pwd" type="password" placeholder="New Pass..." class="form-control" aria-required="true" aria-invalid="false">
                                </div>
