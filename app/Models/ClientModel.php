...
class ClientModel extends Model
{
    ...
    protected $allowedFields = ['cl_reg_as', 'cl_h_name', 'cl_county','cl_cont_desig', 'cl_eircode','cl_cont_name','cl_cont_email','cl_usr','cl_cont_pwd', 'cl_cont_phone','cl_address','cl_status','Reset_Token', 'Reset_Token_Expiry'];
