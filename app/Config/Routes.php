...
$routes->match(['get' , 'post'], 'backend/order-publish-view/(:any)', 'admin\Backend::order_publish_view/$1' ,['filter' => 'B_auth']);
...
$routes->match(['get' , 'post'], 'backend/end-locum/(:any)', 'admin\Backend::EndLocum/$1',['filter' => 'B_auth']);
...
$routes->match(['get' , 'post'], 'emails/view_SentEmail/(:any)', 'emails\emails::view_SentEmail/$1',['filter' => 'EM_auth']);
...
$routes->match(['get' , 'post'], 'emails/SentMail', 'emails\emails::SentMail',['filter' => 'EM_auth']);
// });
