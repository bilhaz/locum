...
$routes->match(['get' , 'post'], 'backend/new_order', 'admin\Backend::new_order' ,['filter' => 'B_auth']);
...
$routes->match(['get' , 'post'], 'backend/notif-seen/(:any)', 'admin\Backend::notif_seen/$1',['filter' => 'B_auth']);
